                           ...
                           <div class="row">
                               <div class="col-md-6">
                                   <x-form-lable name="title"></x-form-lable>
                                       <input type="text" class="form-control" name="title" placeholder="{{__('keywords.title')}}" value="{{$feature->title}}">
                               ...
                               <div class="col-md-12 mt-2">
                                   ...
                                   <textarea class="form-control" rows="4" name="description" placeholder="{{__('keywords.description')}}">{{$feature->description}}</textarea>
